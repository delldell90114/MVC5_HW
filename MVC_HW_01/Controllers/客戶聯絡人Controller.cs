...
namespace MVC_HW_01.Controllers
{
    public class 客戶聯絡人Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,客戶Id,職稱,姓名,Email,手機,電話,is_delete")] 客戶聯絡人 客戶聯絡人)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,客戶Id,職稱,姓名,Email,手機,電話,is_delete")] 客戶聯絡人 客戶聯絡人)
        {
            if (ModelState.IsValid)
            {
